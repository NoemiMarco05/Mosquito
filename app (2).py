...
# Sidebar a sinistra 
st.sidebar.title("Sidebar Sinistra")
sidebar_image_left = Image.open("mosquitobase.png")
st.sidebar.image(sidebar_image_left, width=150)

# Sidebar a destra
col1, col2, col3 = st.columns([1, 2, 1])  # Divisione layout
with col3:  # Ultima colonna a destra
    st.title("Sidebar Destra")
    sidebar_image_right = Image.open("mosquitolight.png")
    st.image(sidebar_image_right, width=150)
